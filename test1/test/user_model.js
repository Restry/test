...
var mongoose = require('mongoose')  
  , connectionString = 'mongodb://42.121.119.36:27017/exam_weixin_teset'
  , options = {};
...
describe('UserModel', function(){
  ...
  after(function(){
    // runs after all tests in this block
			console.log('to be remove all data');
  ...
  describe('#getAuthenticated()', function(){
    it('should return 32 when auto save Password1234 encrypted string length', function(done){
	    // attempt to authenticate user
	    User.getAuthenticated('sang_test1', 'Password1234', function(err, user, reason) {
        if (err) throw err;
        ...
        if (user) {
            ...
            console.log('login success ' + user.password);
						assert.lengthOf(user.password,32)
						done();//success
            return;
        }
